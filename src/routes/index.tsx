...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Plan a Tobago dive holiday from Castara with guided reef dives, PADI certification courses, equipment rental and local help planning your time underwater.' },
